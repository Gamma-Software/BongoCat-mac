...
echo "4) Build release app and package"
echo "5) Build release app, package and install locally"
echo "6) Bump version, build release and deliver to GitHub"
echo "7) Bump version with commit/push, build release and deliver"
echo "8) Exit"
echo ""
